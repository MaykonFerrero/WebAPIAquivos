...
## Pré-requisitos
1. Antes de começar, você vai precisar intalar o Visual Studio em sua máquina.
2. Para utilizar a solução é preciso ter algum cliente REST instalado, como o Insomnia (https://insomnia.rest/download) ou Postman.
